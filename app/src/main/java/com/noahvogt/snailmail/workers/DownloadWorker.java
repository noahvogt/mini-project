...
public class DownloadWorker extends Worker {
    ...
    public DownloadWorker(@NonNull Context appContext, @NonNull WorkerParameters workerParameters) {
    ...
    public Result doWork() {
        try {
            ...
            SharedPreferences credentialsReader = getApplicationContext()
            ...
            ArrayList<MailServerCredentials> currentUsersCredentials = gson.fromJson(readJsonData,
                    credentialsType);
            ...
            Folder[] folders = MailboxLister.list(
                    IMAPStoreConnector.getConncetion(mImapHost, mImapPort, mUser, mPassword), true);

            for (Folder folder : folders) {
                String folderName;
                String folderNow = folder.getFullName();

                if (folderNow.equals("Inbox") || folderNow.equals("INBOX")
                        || folderNow.equals("inbox")) {
                    folderName = "Inbox";
                } else if (folderNow.equals("Trash") || folderNow.equals("TRASH")
                        || folderNow.equals("Delete") || folderNow.equals("DELETE")
                        || folderNow.equals("Papierkorb")) {
                    folderName = "Delete";
                } else if (folderNow.equals("Sent") || folderNow.equals("SENT")
                        || folderNow.equals("Gesendete Objekte")) {
                    folderName = "Sent";
                } else if (folderNow.equals("Archive") || folderNow.equals("ARCHIVE")
                        || folderNow.equals("Archiv/2021") || folderNow.equals("Archiv/2022")
                        || folderNow.equals("Archiv/2020")) {
                    folderName = "Archive";
                } else if (folderNow.equals("Draft") || folderNow.equals("Drafts")
                        || folderNow.equals("DRAFT") || folderNow.equals("DRAFTS")
                        || folderNow.equals("Entw&APw-rfe")) {
                    folderName = "Draft";
                } else if (folderNow.equals("Spam") || folderNow.equals("SPAM")
                        || folderNow.equals("Bulk Mail") || folderNow.equals("bulk mail")
                        || folderNow.equals("Spamverdacht")) {
                    folderName = "Spam";
                } else {
